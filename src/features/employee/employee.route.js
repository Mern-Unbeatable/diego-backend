...
router.get('/courses', companyAdminGuard, employeeController.getCompanyCourses);
...
router.post('/enrollments/:enrollmentId/reminder', companyAdminGuard, employeeController.sendEnrollmentReminder);
